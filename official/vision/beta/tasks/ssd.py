...
from official.vision.beta.configs import ssd as exp_cfg
from official.vision.beta.dataloaders import input_reader_factory
from official.vision.beta.dataloaders import ssd_input
...
@task_factory.register_task_cls(exp_cfg.SSDTask)
class SSDTask(base_task.Task):
  """A single-replica view of training procedure.

  SSD task provides artifacts for training/evalution procedures, including
    ...
    if params.tfds_name:
      ...
      if params.decoder.type == 'simple_decoder':
        ...
        raise ValueError('Unknown decoder type: {}!'.format(
            params.decoder.type))
    isa_ratio = self.task_config.model.anchor.interpolated_scale_aspect_ratio
    parser = ssd_input.Parser(
        output_size=self.task_config.model.input_size[:2],
        min_level=self.task_config.model.min_level,
        num_layers=self.task_config.model.num_layers,
        min_scale=self.task_config.model.anchor.min_scale,
        max_scale=self.task_config.model.anchor.max_scale,
        scales=self.task_config.model.anchor.scales,
